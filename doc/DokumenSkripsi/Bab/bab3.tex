...
\begin{table}[H]
	...
	\begin{tabular}{|c|c|c|}
		...
		\rowcolor{LightRed} 1.4.11 & AA & Tidak Sukses\\
		1.4.12 & AA & Sukses\\
		1.4.13 & AA & Sukses\\
		\hline
...
Kriteria ini tidak sukses karena masih ada konten \textit{non-text} yang memiliki kontras dengan perbandingan 3:1 terhadap warna yang berdekatan. Tampilan halaman web dapat dilihat pada gambar \ref{fig:kepatuhan_1_4_11_reflow}.
\begin{figure}[H]
	\centering  
