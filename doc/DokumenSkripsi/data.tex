...
\textit{Web Content Accessibility Guidelines}(\textit{WCAG}) 2.1 telah membuat pedoman untuk mengukur kemudahan sebuah situs dapat diakses. Hasil pengukurannya disebut tingkat kepatuhan. Aplikasi \textit{SharIF Judge} akan diukur tingkat kepatuhannya terhadap pedoman \textit{WCAG} 2.1. Beberapa bagian dalam aplikasi \textit{SharIF Judge} yang belum memenuhi syarat akan diperbaiki untuk meningkatkan tingkat kepatuhan \textit{SharIF Judge}.
